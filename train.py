...
if args.network == 'sqnxt':
    from anode.models.sqnxt import sqnxt_23_1x, lr_schedule

    writer = SummaryWriter('sqnxt/' + args.method + '_lr_' + str(args.lr) + '_Nt_' + str(args.Nt) + '/')
elif args.network == 'resnet':
    from anode.models.resnet import resnet18, lr_schedule
...
if args.network == 'sqnxt':
    net = sqnxt_23_1x(10, make_odeblock(args.Nt, args.method))
elif args.network == 'resnet':
    net = resnet18(make_odeblock(args.Nt, args.method))
else:
